...
public interface BlockModeler {
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> simpleCubeAll(){
        return (tBlockEntry, modelGenerator) -> modelGenerator.registerSimpleCubeAll(tBlockEntry.getValue());
    }
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> prefixedMultiSimpleCubeAll(String prefix, String... suffixes){
        return (tBlockEntry, modelGenerator) -> {
    ...
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> multiSimpleCubeAll(String... suffixes){
        return prefixedMultiSimpleCubeAll("", suffixes);
    }
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> slab(Block block){
        return (tBlockEntry, modelGenerator) -> {
    ...
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> stairs(Block block){
        return (tBlockEntry, modelGenerator) -> {
    ...
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> pillar(){
        return (tBlockEntry, modelGenerator) -> modelGenerator.registerAxisRotated(tBlockEntry.get(), TexturedModel.CUBE_COLUMN);
    }
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> wall(Block block, boolean withItem){
        return (tBlockEntry, modelGenerator) -> {
            Identifier oId = TextureMap.getId(block);
    ...
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> button(Block block, boolean withItem){
        return (tBlockEntry, modelGenerator) -> {
            Identifier oId = TextureMap.getId(block);
    ...
    static <T extends Block> BiConsumer<BlockEntry<T>, BlockStateModelGenerator> pressurePlate(Block block){
        return (tBlockEntry, modelGenerator) -> {
            Identifier oId = TextureMap.getId(block);
